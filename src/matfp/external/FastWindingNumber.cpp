...
#include "matfp/external/WindingNumber.h"
...
void matfp::fast_winding_number(const Eigen::MatrixXd &V,
  ...
  std::vector<igl::FastWindingNumber::HDK_Sample::UT_Vector3T<float> > U(
      V.rows());
