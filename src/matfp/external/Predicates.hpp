...
class Predicates {
 public:
  ...
  static int orient_3d(const Vector3& p1, const Vector3& p2, const Vector3& p3,
                       const Vector3& p4);
  static int orient_3d_tolerance(const Vector3& p1, const Vector3& p2,
                                 const Vector3& p3, const Vector3& p4);
  static Scalar orient_3d_volume(const Vector3& p1, const Vector3& p2,
                                 const Vector3& p3, const Vector3& p4);
