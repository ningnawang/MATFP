...
/* Generated from source file: powerside3.pck */

inline int side3_3d_filter( const double* p0, double w0, const double* p1, double w1, const double* p2, double w2, const double* p3, double w3, const double* q0, const double* q1, const double* q2) {
    ...
    if( ((lower_bound_1 < 5.20148534133144899158e-43) || (max9 < 2.70554497560859409375e-85)) )
    {
        return FPG_UNCERTAIN_VALUE;
    } 
    else 
    {
        if( ((upper_bound_1 > 2.59614842926741294957e+33) || (max9 > 6.73998666678765545893e+66)) )
        {
            return FPG_UNCERTAIN_VALUE;
        } 
        eps = (2.15999516513628047052e-12 * (((((max6 * max1) * max2) * max7) * max4) * std::max( max5, std::max( max8, max9 ) )));
        if( (r > eps) )
        {
